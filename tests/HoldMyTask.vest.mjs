 ...
 *	-----
 *	@Last modified by: Nate Hyson <CLDMV> (Shinrai@users.noreply.github.com)
 *	@Last modified time: 2025-11-08 21:16:42 -08:00 (1762665402)
 *	-----
 *	@Copyright: Copyright (c) 2013-2025 Catalyzed Motivation Inc. All rights reserved.
 */
 ...
 *	-----
 *	@Last modified by: Nate Hyson <CLDMV> (Shinrai@users.noreply.github.com)
 *	@Last modified time: 2025-11-08 19:56:51 -08:00 (1762660611)
 *	-----
 *	@Copyright: Copyright (c) 2013-2025 Catalyzed Motivation Inc. All rights reserved.
 */
 ...
 *	-----
 *	@Last modified by: Nate Hyson <CLDMV> (Shinrai@users.noreply.github.com)
 *	@Last modified time: 2025-11-08 19:12:45 -08:00 (1762657965)
 *	-----
 *	@Copyright: Copyright (c) 2013-2025 Catalyzed Motivation Inc. All rights reserved.
 */
...
test("respects concurrency limit", async () => {
	const q = new HoldMyTask({ concurrency: 2, autoStart: false });
	let running = 0;
	const maxRunning = [];
...
test("cancels tasks", async () => {
	const q = new HoldMyTask({ autoStart: false });
	let executed = false;
...
test("respects maxQueue limit", () => {
	const q = new HoldMyTask({ maxQueue: 2 });
...
test("expire works with priority and bypass", async () => {
	const q = new HoldMyTask({ autoStart: false, delays: { 1: 100 } });
